                    ...
                    <div class="col-12">
                        <div class="QA_section">
                            <div class="white_box_tittle list_header">
                                <h4 style="text-align:center; margin-top:10px !important; ">VAULT NUMBER : <span style="color:#FFB400;"><?php gdetail($_SESSION['vaultuser']['gold_id'], 'vaultnumber'); ?> </span> <button  style="margin-left:7px;" class="btn btn-danger logoutvault">Logout</button></h4>
